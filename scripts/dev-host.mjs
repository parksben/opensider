...
// 扩展目录由二进制决定（`opensider extension-dir`：用户在安装时选的，没选过就是
// 下载目录下的 OpenSider）。开发时跟着它走，才能在浏览器里加载同一个目录。
const extension = execFileSync(bin, ["extension-dir"], { encoding: "utf8" }).trim();
