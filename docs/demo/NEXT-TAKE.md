...
> **当前成片**：[`opensider.mp4`](./opensider.mp4)（**2880×1800**，**14.3s**）：The Verge → 两句人话搜今日最热 AI 新闻 → HTML → Agent 打开简报 → **人手滚动预览**。打开到开滚之间的空等要切掉。原片 4–31s（打字到打开简报）**4.5x 压成 6s**；头 4s 与结尾滚动仍 1x。
>
...
成片目标 **≤45s**（工艺对齐 take7）。打字可加速；发送前空等硬切；Agent 空等/流式可跳切。当前成片把原 4–31s **4.5x 压成 6s**。
