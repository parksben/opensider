	...
	return []AgentProfile{
		{
			...
			ModeMap:        map[protocol.AgentPolicy][]string{protocol.PolicyAsk: {"agent"}, protocol.PolicyWorkspace: {"agent"}, protocol.PolicyAuto: {"agent"}},
		...
		},
		{
			...
			ModeMap:      map[protocol.AgentPolicy][]string{protocol.PolicyAsk: {"default", "ask"}, protocol.PolicyWorkspace: {"acceptEdits"}, protocol.PolicyAuto: {"bypassPermissions", "auto"}},
			ContextFiles: []string{"AGENTS.md"},
		...
		},
		{
			...
			Env:            codebuddyEnv,
			Auth:           AuthKind{Type: "none"},
			ModeMap:        map[protocol.AgentPolicy][]string{protocol.PolicyAsk: {"default"}, protocol.PolicyWorkspace: {"default"}, protocol.PolicyAuto: {"auto"}},
			ContextFiles:   []string{"AGENTS.md"},
		...
		},
		{
			...
			Auth:         AuthKind{Type: "none"},
			ModeMap:      map[protocol.AgentPolicy][]string{protocol.PolicyAsk: {"agent"}, protocol.PolicyWorkspace: {"agent"}, protocol.PolicyAuto: {"agent-full-access"}},
			ContextFiles: []string{"AGENTS.md"},
